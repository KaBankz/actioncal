...
export const siteConfig = {
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Get paid directly for the data you're already generating online.",
      icon: <DollarSignIcon className="h-6 w-6" />,
    },
    {
      name: "Privacy Control",
      description:
        "Choose what data to share and maintain full control over your privacy.",
      icon: <ShieldCheckIcon className="h-6 w-6" />,
    },
    {
      name: "High-Quality Data",
      description:
        "Access ethically sourced, comprehensive user data for better insights.",
      icon: <DatabaseIcon className="h-6 w-6" />,
    },
    {
      name: "Real-time Analytics",
      description: "Track your earnings and data usage in real-time.",
  ...
  featureHighlight: [
    ...
    },
    {
      ...
      description:
        "Our browser extension automatically tracks and monetizes your data while ensuring your privacy.",
      imageSrc: "/Device-2.png",
      direction: "rtl" as const,
    },
    {
      ...
      description:
        "Choose what to share and what to keep private. You're always in control.",
      imageSrc: "/Device-3.png",
      direction: "ltr" as const,
    },
    {
      ...
      description:
        "See exactly how your data is used and what you earn in real-time.",
      imageSrc: "/Device-4.png",
      direction: "rtl" as const,
    },
  ],
  ...
  pricing: [
    {
      ...
      description: "For individual data providers",
    ...
    },
    {
      ...
      description: "For businesses needing quality data",
